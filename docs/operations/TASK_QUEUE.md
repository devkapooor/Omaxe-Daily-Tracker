...
- [x] Extract shared cheque-mode state into `src/features/register/components/useChequeDetails.ts`.
- [x] Extract shared stat card UI into `src/features/dashboard/components/SummaryCard.tsx`.
