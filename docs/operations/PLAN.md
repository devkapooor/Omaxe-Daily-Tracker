...
- extracted shared cheque-mode state into `src/features/register/components/useChequeDetails.ts`
- extracted shared stat card UI into `src/features/dashboard/components/SummaryCard.tsx`
