...
export function DirectoryPage({
  ...
  return (
    <section className="grid gap-2.5">
      ...
      <Tabs defaultValue="vendors" className="grid gap-2.5">
        ...
        <TabsContent value="vendors">
          <div className="grid gap-2.5 xl:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)] xl:items-stretch">
            <Card className="xl:flex xl:min-h-0 xl:flex-col xl:h-full">
              ...
              <CardContent className="xl:flex-1 xl:overflow-y-auto">
                <form className="grid gap-3.5 md:grid-cols-2" onSubmit={handleVendorSubmit}>
            ...
            <Card className="flex min-h-0 flex-col xl:h-full">
              ...
              <CardContent className="min-h-0 flex-1 overflow-hidden">
                <div className="grid max-h-[26rem] gap-2.5 overflow-y-auto pr-1 sm:max-h-[30rem] xl:min-h-0 xl:max-h-[calc(100dvh-17rem)]">
                  {filteredVendors.length === 0 ? <p className="text-sm font-medium text-muted-foreground">No vendors found.</p> : null}
                  {filteredVendors.map((vendor) => (
                    <button
                      key={vendor.id}
                      type="button"
                      className="rounded-[18px] border border-border/70 bg-secondary/55 p-3.5 text-left transition-colors hover:bg-secondary/75"
      ...
      {selectedVendor ? (
        <div className="fixed inset-0 z-[140] flex items-center justify-center bg-slate-950/40 px-3 py-6 backdrop-blur-sm">
          <Card className="max-h-[90vh] w-full max-w-[36rem] overflow-y-auto">
